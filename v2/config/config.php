...
const CONFIG = [
    ...
    */
    ...
    'site_title' => 'All Affordable Plumbing Inc.',
    'tag_line' => '',
    'phone' => '(847) 474-1880',
    'site_url' => 'https://frontend.smartwebsitedesign.com/lp-all-affordable-plumbing', // ABSOLUTE_PATH // Do NOT add trailing slash '/'

    'site_email' => 'all_affordable@hotmail.com', // Leave Blank or comment for no email in footer
    ...
    */
    'to' => [
        // 'all_affordable@hotmail.com' => 'All Affordable Plumbing Inc.'
        'frontend@smartsites.com' => 'FED SmartSites'
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'smtp' => [
        // 'smtp_email' => 'smartsitesmailer@gmail.com',
        // 'smtp_password' => 'heymcdslbnrmbiba',
        'smtp_email' => 'birsanh1@gmail.com',
        'smtp_password' => 'vtuufzcnaryrqvie',
...
function successMessage()
{
    ...
    return "<div class='thank-you-message'><p class='thank-you-heading'>Thank you for reaching out!</p>" .
        "<p class='thank-you-content'>You will hear from us shortly.</p>";
}
